<section class="content-header">
    ...
    <section class="content"> 
        	...
        	<h3 class="box-tittle"><?=ucfirst($page)?> Surat Tugas</h3>
					<div class="pull-right">
						<a href="<?=site_url('st')?>"class="btn btn-warning btn-flat">
      ...
      <div class="box-body">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				<?php echo form_open_multipart('st/proses') ?>							
					<div class="form-group">
					<input type="hidden" name="id" value="<?=$row->st_id?>">
					...
					<div class="form-group">
						...
						<input type="text" name="jenis_tugas" value="<?=$row->jenis_tugas?>" class="form-control" required>
					</div>
					<div class="form-group">
