<section class="content-header">
    ...
    <section class="content"> 
        	...
        	<h3 class="box-tittle">Data Cuti Tenaga Ahli</h3>
					<div class="pull-right">
						<a href="<?=site_url('cuti/add')?>"class="btn btn-primary btn-flat">
							<i class="fa fa-plus"></i> Tambah Data Cuti Tenaga Ahli
						</a>
            ...
            <tr>
              <td><?=$no++?>.</td>
							...
							<td class="text-center" width="160 px">
								<a href="<?=site_url('cuti/edit/'.$data->cuti_id)?>" class="btn btn-primary btn-xs">
							<i class="fa fa-pencil"></i> Update
						</a>
								<a href="<?=site_url('cuti/delete/'.$data->cuti_id)?>" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data Ini?')" class="btn btn-danger btn-xs">
