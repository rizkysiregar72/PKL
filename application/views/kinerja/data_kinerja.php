<section class="content-header">
    ...
    <section class="content"> 
        	...
        	<h3 class="box-tittle">Data Kinerja Tenaga Ahli</h3>
					<div class="pull-right">
						<a href="<?=site_url('kinerja/add')?>"class="btn btn-primary btn-flat">
							<i class="fa fa-plus"></i> Tambah Data Kinerja Tenaga Ahli
						</a>
            ...
            <tr>
              <td><?=$no++?>.</td>
							...
							<td class="text-center" width="160 px">
								<a href="<?=site_url('kinerja/edit/'.$data->kinerja_id)?>" class="btn btn-primary btn-xs">
							<i class="fa fa-pencil"></i> Update
						</a>
								<a href="<?=site_url('kinerja/delete/'.$data->kinerja_id)?>" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data Ini?')" class="btn btn-danger btn-xs">
